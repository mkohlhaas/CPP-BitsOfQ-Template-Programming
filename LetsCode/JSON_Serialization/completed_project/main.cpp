...
template <typename T>
NVP<T>
nvp(const std::string &name, const T &value)
{
...
void
serialize(JSONWriter &writer, const Address &a)
{
...
void
serialize(JSONWriter &writer, const Person &p)
{
