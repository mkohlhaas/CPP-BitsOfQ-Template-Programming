...
namespace bits_of_q::composed_defaults
{
    ...
    namespace detail
    {
        ...
        template <typename... T0s, typename... T1s, typename... T2s, typename... T3s, typename... T4s, typename... T5s,
                  typename... T6s, typename... T7s, typename... T8s, typename... T9s, typename... T10s,
                  typename... T11s, typename... T12s, typename... T13s, typename... T14s, typename... T15s>
        struct join16<type_list<T0s...>, type_list<T1s...>, type_list<T2s...>, type_list<T3s...>, type_list<T4s...>,
                      type_list<T5s...>, type_list<T6s...>, type_list<T7s...>, type_list<T8s...>, type_list<T9s...>,
                      type_list<T10s...>, type_list<T11s...>, type_list<T12s...>, type_list<T13s...>,
                      type_list<T14s...>, type_list<T15s...>>
        {
            using type = type_list<T0s..., T1s..., T2s..., T3s..., T4s..., T5s..., T6s..., T7s..., T8s..., T9s...,
                                   T10s..., T11s..., T12s..., T13s..., T14s..., T15s...>;
        };
    } // namespace detail
    ...
    template <typename L0 = type_list<>, typename L1 = type_list<>, typename L2 = type_list<>,
              ...
              typename L15 = type_list<>, typename... MORE_LISTS>
    struct join
    {
        using type = typename join<
            typename detail::join16<L0, L1, L2, L3, L4, L5, L6, L7, L8, L9, L10, L11, L12, L13, L14, L15>::type,
            MORE_LISTS...>::type;
    };
