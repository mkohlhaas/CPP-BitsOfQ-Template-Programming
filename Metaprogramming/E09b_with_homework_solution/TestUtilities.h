...
namespace bits_of_q
{
    ...
    template <size_t i>
    inline std::ostream &
    operator<<(std::ostream &os, const IndexedCopyCounter<i> &c)
    {
...
namespace bits_of_q::testing
{
    ...
    struct AssertEqFailed : public AssertFailed
    {
        explicit AssertEqFailed(std::string_view file_path, size_t line, std::string assert_expression,
            ...
            : AssertFailed(file_path, line, std::move(assert_expression)), value1(std::move(value_string1)),
...
#define ASSERT_EQ(expr1, expr2)                                                                                        \
    ...
    inline void
    output_specific_assert_info(const AssertFailed &)
    {
    }

    inline void
    output_specific_assert_info(const AssertEqFailed &e)
    {
