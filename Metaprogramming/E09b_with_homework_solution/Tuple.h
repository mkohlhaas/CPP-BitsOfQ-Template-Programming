...
namespace bits_of_q
{
    ...
    namespace detail
    {
        ...
        struct tuple_cat_impl
        {
            ...
            {
                return f(concat_with_fwd_tuple<std::make_index_sequence<tuple_size_v<std::remove_cvref_t<FWD_TUPLE>>>,
    ...
    namespace detail
    {
        ...
        constexpr auto
        transform_impl(TUP &&tup, const FUNC &f, std::index_sequence<indices...>)
        {
    ...
    constexpr auto
    transform(TUP &&tup, const FUNC &f)
    {
        return detail::transform_impl(std::forward<TUP>(tup), f,
    ...
    namespace detail
    {
        ...
        constexpr auto
        cat_tuple_content_as(TUP &&t, std::index_sequence<indices...>)
        {
        ...
        constexpr auto
        wrap_filtered(TUP &&tup, std::index_sequence<indices...>)
        {
    ...
    filter(TUP &&tup)
    {
        auto wrapped_tup = detail::wrap_filtered<PREDICATE>(
            std::forward<TUP>(tup), std::make_index_sequence<tuple_size_v<std::remove_cvref_t<TUP>>>{});
        ...
        return detail::cat_tuple_content_as<detail::filter_result_t<std::remove_cvref_t<TUP>, PREDICATE>>(
            std::move(wrapped_tup), std::make_index_sequence<tuple_size_v<std::remove_cvref_t<TUP>>>{});
