    ...
    namespace detail
    {
        ...
        { // up to 4^2 = 16
            ...
            template <typename... T0s, typename... T1s, typename... T2s, typename... T3s, typename... T4s,
                      typename... T5s, typename... T6s, typename... T7s, typename... T8s, typename... T9s,
                      typename... T10s, typename... T11s, typename... T12s, typename... T13s, typename... T14s,
                      typename... T15s>
...
struct join_select<4> { // more than 64
    ...
    {
        using type =
            typename detail::join_select<detail::select_join_size(sizeof...(LISTS))>::template join<LISTS...>::type;
    };
